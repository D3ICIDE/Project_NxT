...
public class NirCmdService {
    ...
    public static void runProcess(String commandString) {
        int debugCode = 0;
        try {
            ...
            e.printStackTrace();
            //return ("Unsuccessful Execution of" + commandString + " [Error Code]: "+debugCode);
        }
       // return("Successfully Executed"+commandString);
    }
}